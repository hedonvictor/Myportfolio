...
export default function Initial() {
    return (
        <section className="container d-flex justify-content-around mt-5">
            <Card className="border-0 shadow-lg d-flex justify-content-center" style={{ maxWidth: "540px" }}>
                <Card.Body className="p-4">
                    ...
                    <div className="p-3 contacts">
                        <h4>Contate-me:</h4>
                        <a href="https://github.com/hedonvictor" target="_blank" className="me-2 ms-4">
                        ...
                        <a href="https://www.linkedin.com/in/hédon-victor-amaro-b26631225/" target="_blank" className="me-2">
                        ...
                        <a target="_blank" className="me-2">
                        ...
                        <a href="https://www.instagram.com/eae.hedon/" target="_blank">
            ...
            <div className="card border-0 shadow-lg" style={{ maxWidth: "540px" }}>
                <img alt="img" src={myImg} />
            </div>
        </section>
    )
}